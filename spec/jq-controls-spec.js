...
},{"./array-generics.coffee":"/Users/nickbottomley/Documents/dev/experiments/jquery-controls/spec/array-generics.coffee","./mixin-spec.coffee":"/Users/nickbottomley/Documents/dev/experiments/jquery-controls/spec/mixin-spec.coffee","./selectors.coffee":"/Users/nickbottomley/Documents/dev/experiments/jquery-controls/spec/selectors.coffee","./spec-utilities.coffee":"/Users/nickbottomley/Documents/dev/experiments/jquery-controls/spec/spec-utilities.coffee"}],"/Users/nickbottomley/Documents/dev/experiments/jquery-controls/spec/array-generics.coffee":[function(require,module,exports){
var demethodize;
...
},{}],"/Users/nickbottomley/Documents/dev/experiments/jquery-controls/spec/mixin-spec.coffee":[function(require,module,exports){
var BUTTON, CHECK, CHECKABLE, Controls, RADIO, TAGS, Values, every, expect, filter, first, fs, jQuery, last, map, reduce, sameSelection, sinon, slice, some, trees, _ref, _ref1;
...
describe("Control prototype methods", function() {
  ...
  describe("@labels", function() {
    return it("selects the labels of the controls", function() {
      ...
      return expect(sameSelection($.mixinControls($(root)).labels(), lbls)).to.be["true"];
    });
  });
  describe("@valid", function() {
    it("delegates to Controls.validateElement", function() {
  ...
  return describe("@bindValidator", function() {});
});
...
},{"./array-generics.coffee":"/Users/nickbottomley/Documents/dev/experiments/jquery-controls/spec/array-generics.coffee","./selectors.coffee":"/Users/nickbottomley/Documents/dev/experiments/jquery-controls/spec/selectors.coffee","./spec-utilities.coffee":"/Users/nickbottomley/Documents/dev/experiments/jquery-controls/spec/spec-utilities.coffee"}],"/Users/nickbottomley/Documents/dev/experiments/jquery-controls/spec/selectors.coffee":[function(require,module,exports){
module.exports = {
