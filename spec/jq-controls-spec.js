...
jQuery = window.jQuery, sinon = window.sinon;
...
},{"../src/jquery-controls.coffee":10,"./array-generics.coffee":1,"./bind.coffee":2,"./selectors.coffee":4,"./spec-utilities.coffee":5}],4:[function(require,module,exports){
module.exports = {
...
},{"./get-value.coffee":7,"./is-valid.coffee":9,"./matches-polyfill.coffee":11,"./selectors.coffee":13,"./utils.coffee":14,"./values.coffee":16}],7:[function(require,module,exports){
...
},{"./selectors.coffee":13}],8:[function(require,module,exports){
...
},{"./controls.coffee":6,"./mixin.coffee":12}],9:[function(require,module,exports){
...
},{"./validations.coffee":15}],10:[function(require,module,exports){
module.exports = (function($) {
  require("./init.coffee");
  $.Controls = require("./controls.coffee");
  $.Values = require("./values.coffee");
...
},{"./controls.coffee":6,"./init.coffee":8,"./values.coffee":16}],11:[function(require,module,exports){
(function(Element) {
...
},{"./controls.coffee":6,"./selectors.coffee":13}],13:[function(require,module,exports){
module.exports = {
  CHECKABLE: "input[type='radio'], input[type='checkbox']",
  BUTTON: "input[type='button'], button",
  TAGS: "input, select, button, textarea",
...
},{"./selectors.coffee":13,"./utils.coffee":14}],16:[function(require,module,exports){
var Values;
